...
const CTA = () => {
  return (
    <section className="relative px-6 pb-24 lg:pb-32">
      {/* Decorative aura */}
      <div className="absolute bottom-0 left-1/2 -z-10 h-[300px] w-[600px] -translate-x-1/2 rounded-full bg-primary-blue/5 blur-[100px]" />

      <div className="relative mx-auto max-w-6xl overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-slate-900 via-slate-900 to-primary-blue-dark/50 px-8 py-16 text-center text-white shadow-2xl shadow-slate-950/20 lg:px-16 lg:py-24">
        {/* Subtle geometric lines */}
        <div className="absolute inset-0 opacity-10 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(20,40,160,0.5),rgba(255,255,255,0))]" />
        
        <div className="relative z-10 mx-auto max-w-3xl">
          <div className="mb-4 inline-flex items-center gap-1.5 rounded-full bg-primary-blue/10 px-3.5 py-1.5 text-primary-blue-light border border-primary-blue/10">
            <Sparkles className="h-4.5 w-4.5 text-primary-blue-light animate-pulse" />
          ...
          <p className="mx-auto mt-6 max-w-2xl text-base md:text-lg text-slate-350 leading-relaxed">
